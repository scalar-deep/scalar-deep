...
A machine learning project that predicts UK road accident severity using data preprocessing, feature engineering, SMOTE, multiple ML models, and SHAP explainability.
...
**Machine Learning:** Scikit-learn, Pandas, NumPy, SHAP, Imbalanced-learn  
**AI Tools:** Ollama, Whisper, Piper TTS  
